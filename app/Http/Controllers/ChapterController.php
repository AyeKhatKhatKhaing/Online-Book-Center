...
//        return $title;
        $chapters=Chapter::where([['sub_title',$title],['name',auth()->user()->name ]])->latest()->limit(10)->get();
//        return $chapters;
...
//        return $title;
    ...
    public function delete($id)
    {
        ...
        $chapter->delete();
        $title=$chapter->sub_title;
        return redirect()->route( 'chapter-insert',$title)->with("toast"," Chapter Deletd Successfully");
