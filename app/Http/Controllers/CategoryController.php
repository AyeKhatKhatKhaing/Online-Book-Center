...
class CategoryController extends Controller
{
    ...
    public function category($title){
        $books=Category::where([['main_title',$title],['ads','paid'],['name',auth()->user()->name ]])->latest()->limit(10)->get();
        $fbooks=Category::where([['main_title',$title],['ads','free'],['name',auth()->user()->name ]])->latest()->limit(10)->get();
...
//        return $request;
    ...
    {
        $category= Category::where([['id',$id],['name',auth()->user()->name ]])->first();
        $category->type='done';
        $category->update();
